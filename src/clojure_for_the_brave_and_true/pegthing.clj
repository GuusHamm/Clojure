(ns clojure-for-the-brave-and-true.pegthing
...
(defn tri*
  "Generates lazy secuence of traingular numbers"
  ([] (tri* 0 1))
  ([sum n]
    (let [new-sum (+ sum n)]
...
(defn pegged?
  "Does the postion hava a peg in it?"
  [board pos]
...
(defn valid-moves
  "Returns a map of all valid moves for pos, where the key is the destination and thevalue is the jumped position"
  [board pos]
  (into {}
